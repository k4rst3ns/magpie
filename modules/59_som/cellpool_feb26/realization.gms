...
*' @description
*' The cellpool_feb26 realization is built on revised IPCC 2019 Guidelines for
...
*' This realization extends cellpool_jan23 with flexible SCM target calculation modes,
*' allowing targets to be based either on previous timestep cropland area (dynamic) or
*' fixed to a specific reference year's cropland area (static).
...
$Ifi "%phase%" == "sets" $include "./modules/59_som/cellpool_feb26/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/59_som/cellpool_feb26/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/59_som/cellpool_feb26/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/59_som/cellpool_feb26/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/59_som/cellpool_feb26/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/59_som/cellpool_feb26/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/59_som/cellpool_feb26/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/59_som/cellpool_feb26/postsolve.gms"
