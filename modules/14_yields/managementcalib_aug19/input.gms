...
s14_eroi_yield_penalty_max        Energy Return On Investment (EROI) yield penalty for bioenergy crops (0=no penalty, 1=full penalty) / 0 /
s14_be_tau_share                  Share of technological change passed through to bioenergy crop yields (1=full, 0=none) / 1 /
