...
scalars
 s18_disagg_include include disaggregated constrain (1) / 1 /
 s18_pos_var positive variable (1) / 0 /
;
...
$ondelim
$include "./modules/18_residues/disaggRes_mar25/input/f18_cgf.csv"
$offdelim;
...
$ondelim
$include "./modules/18_residues/disaggRes_mar25/input/f18_res_use_burn.cs3"
$offdelim;
...
/
$ondelim
$include "./modules/18_residues/disaggRes_mar25/input/f18_fac_req_kres.csv"
$offdelim
/;
