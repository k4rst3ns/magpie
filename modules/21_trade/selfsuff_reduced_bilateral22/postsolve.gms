...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 oq21_trade_lower_bloc(t,i_ex,i_im,k_trade,"marginal") = q21_trade_lower_bloc.m(i_ex,i_im,k_trade);
 oq21_trade_upper_bloc(t,i_ex,i_im,k_trade,"marginal") = q21_trade_upper_bloc.m(i_ex,i_im,k_trade);
 oq21_costs_tariffs_bloc(t,i,k_trade,"marginal")       = q21_costs_tariffs_bloc.m(i,k_trade);
 ...
 oq21_trade_lower_bloc(t,i_ex,i_im,k_trade,"level")    = q21_trade_lower_bloc.l(i_ex,i_im,k_trade);
 oq21_trade_upper_bloc(t,i_ex,i_im,k_trade,"level")    = q21_trade_upper_bloc.l(i_ex,i_im,k_trade);
 oq21_costs_tariffs_bloc(t,i,k_trade,"level")          = q21_costs_tariffs_bloc.l(i,k_trade);
 ...
 oq21_trade_lower_bloc(t,i_ex,i_im,k_trade,"upper")    = q21_trade_lower_bloc.up(i_ex,i_im,k_trade);
 oq21_trade_upper_bloc(t,i_ex,i_im,k_trade,"upper")    = q21_trade_upper_bloc.up(i_ex,i_im,k_trade);
 oq21_costs_tariffs_bloc(t,i,k_trade,"upper")          = q21_costs_tariffs_bloc.up(i,k_trade);
 ...
 oq21_trade_lower_bloc(t,i_ex,i_im,k_trade,"lower")    = q21_trade_lower_bloc.lo(i_ex,i_im,k_trade);
 oq21_trade_upper_bloc(t,i_ex,i_im,k_trade,"lower")    = q21_trade_upper_bloc.lo(i_ex,i_im,k_trade);
 oq21_costs_tariffs_bloc(t,i,k_trade,"lower")          = q21_costs_tariffs_bloc.lo(i,k_trade);
