...
# --------------------------------------------------------------
# description: extract report in rds and mif format from run with EUR aggregated from H16 EU regions
...
report <- getReport(gdx, scenario = cfg$title,
                    level = "/p/projects/rd3mod/inputdata/mappings/regional/regionmappingH16EUAgg_report.csv")
